...
namespace ListExample
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            *   
            *   και μετά αποφασίζω να "περάσω" τον φοιτητή stu1 στο μάθημα c4
            *   
            *   stu1.PassCourse(c4); 
            *   
            *   αν αμέσως μετά δω τα μαθήματα που έχει περάσει ο φοιτητής stu2, θα ΔΩ ΠΩΣ ΕΧΕΙ ΠΕΡΑΣΕΙ ΚΑΙ ΑΥΤΟΣ ΤΟ c4 !!!
            *   
            *   Δείτε το παρακάτω:
            */
