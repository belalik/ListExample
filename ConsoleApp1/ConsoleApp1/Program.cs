...
namespace ListExample
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            * 
            * Το c1 / c2 / c3 κλπ είναι συγκεκριμένα αντικείμενα της κλάσης Course - καταλαμβάνουν συγκεκριμένο 
            * χώρο στην μνήμη του υπολογιστή 
            * όπου και καταχωρούνται κατά την δημιουργία τους.  
            * 
            * Αν βάλω δυο φορές κάποιο (πχ το c1) σε κάποιον φοιτητή - ουσιαστικά έχω βάλει δυο φορές το reference 
            * (την αναφορά) του ΙΔΙΟΥ ΑΝΤΙΚΕΙΜΕΝΟΥ. 
            * 
